...
AmCharts.deleteObject = function (a, b) {
  if (a) {
    ...
    if (0 !== b)if ("[object Array]" === Object.prototype.toString.call(a))for (var c = 0; c < a.length; c++)AmCharts.deleteObject(a[c], b - 1), a[c] = null; else if (a && !a.tagName)try {for (c in a)a[c] && ("object" == typeof a[c] && AmCharts.deleteObject(a[c], b - 1), "function" != typeof a[c] && (a[c] = null))} catch (d) {}
  }
};
...
AmCharts.AmChart = AmCharts.Class({
  ...
  drawLabel:            function (a) {
    if (this.container) {
      ...
      a.url ? (c.setAttr("cursor",
        "pointer"), c.click(function () {AmCharts.getURL(a.url)})) : c.node.style.pointerEvents = "none";
  ...
  addMouseWheel:        function () {
    var a = this;
    window.addEventListener && !a.wheelAdded && (window.addEventListener("DOMMouseScroll", function (b) {a.handleWheel.call(a, b)}, !1), document.addEventListener("mousewheel", function (b) {a.handleWheel.call(a, b)}, !1), a.wheelAdded = !0)
  },
  ...
  addListeners:         function () {
    ...
    }, !0), b.addEventListener("mouseover", function (b) {a.handleMouseOver.call(a, b)}, !0), b.addEventListener("mouseout", function (b) {a.handleMouseOut.call(a, b)}, !0)) : (b.attachEvent("onmousedown", function (b) {a.handleMouseDown.call(a, b)}),
...
AmCharts.AmLegend = AmCharts.Class({
  ...
  createValue:    function (a) {
    ...
    if (!1 !== a.visibleInLegend) {
      ...
      c = b.container.rect(b.markerSize, 0, f, e, 0, 0).attr({stroke: "none", fill: "#ffffff", "fill-opacity": .005});
      c.dItem = a;
...
AmCharts.AmMap = AmCharts.Class({
  ...
  drawBg:                       function () {
    ...
    b.click(function () {a.handleBackgroundClick()});
    a.bgSet = b;
    a.set.push(b)
  },
  ...
  updateSize:                   function () {
    ...
    a.preventHover = !0;
    a.frame <= b ? (a.frame++, b = AmCharts.easeOutSine(0, a.frame, 0, 1, b), 1 <= b ? (b = 1, a.preventHover = !1, a.wheelBusy = !1) : setTimeout(function () {a.updateSize.call(a)},
  ...
  stopDrag:                     function () {this.isDragging && (this.isDragging = !1)},
  ...
  selectObject:                 function (a) {
    ...
    c = b.zoomDuration;
    !f && isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY) ? (b.showDescriptionAndGetUrl(), b.processObjects()) : (b.selectedObjectTimeOut = setTimeout(function () {b.showDescriptionAndGetUrl.call(b)},
      1E3 * c + 200), b.showObjectsAfterZoom ? b.processObjectsTimeOut = setTimeout(function () {b.processObjects.call(b)}, 1E3 * c + 200) : b.processObjects());
    ...
    d !=
    a && (a = {type: "selectedObjectChanged", chart: b}, b.fire(a.type, a))
  },
  ...
  addObjectEventListeners:      function (a, b) {
    var c = this;
    a.mouseup(function (a) {c.clickMapObject(b, a)}).mouseover(function (a) {c.rollOverMapObject(b, !0, a)}).mouseout(function (a) {c.rollOutMapObject(b, a)}).touchend(function (a) {c.clickMapObject(b, a)}).touchstart(function (a) {c.rollOverMapObject(b, !0, a)})
  },
  ...
  showAsRolledOver:             function (a) {
    ...
    if (!a.showAsSelected && b && !a.isOver) {
      ...
      if (void 0 != c)if ("MapImage" == a.objectType)(d = a.image) && d.setAttr("fill", c); else if ("MapLine" == a.objectType) {if ((d = a.lineSvg) && d.setAttr("stroke", c), d = a.arrowSvg)d.setAttr("fill", c), d.setAttr("stroke", c)} else b.setAttr("fill", c);
  ...
  formatString:                 function (a, b) {
    ...
    return a = AmCharts.massReplace(a, {
      "[[title]]":   f, "[[value]]": e,
      "[[percent]]": c, "[[description]]": d, "[[customData]]": g
    })
  },
...
AmCharts.ZoomControl = AmCharts.Class({
  ...
  init:        function (a, b) {
    ...
    if (e) {
      ...
      s.translate(-3, -3);
      s.mouseup(function () {c.handleBgUp()});
      u.push(s);
...
AmCharts.SimpleButton = AmCharts.Class({
  ...
  init:            function (a, b, c, d, f, e, g, h, k, l, m) {
    ...
    d.mousedown(function () {n.handleDown()}).mouseup(function () {n.handleUp()}).mouseover(function () {n.handleOver()}).mouseout(function () {n.handleOut()});
    n.bg = d
  },
    ...
    for (u = 0; u < b.length; u++) {
      ...
      if (q.remainVisible || c.selectedObject == q.parentObject) {
        ...
        if (0 < E.length) {
          ...
          q.fixedSize && N && (this.linesToResize.push({line: N, thickness: B}), this.linesToResize.push({
            line:      G,
            thickness: 3
          }));
          q.lineSvg = N;
...
AmCharts.MapArea = AmCharts.Class({
  inherits: AmCharts.MapObject, construct: function (a) {
    this.cname = "MapArea";
...
AmCharts.MapData = AmCharts.Class({
  inherits: AmCharts.MapObject, construct: function () {
    this.cname = "MapData";
...
AmCharts.DescriptionWindow = AmCharts.Class({
  construct: function () {}, show: function (a, b, c, d) {
    ...
    g.onclick = function () {f.close()};
    g.onmouseover = function () {g.src = a.pathToImages + "xIconH.gif"};
...
AmCharts.ObjectList = AmCharts.Class({
  construct:     function (a) {this.divId = a}, init: function (a) {
    this.chart = a;
    var b;
    b = this.divId;
    ...
    if (a.showInList && void 0 !== a.title) {
      ...
      b.appendChild(d);
      this.addObjects(a, d);
      e.onmouseover = function () {c.chart.rollOverMapObject(a, !1)};
      e.onmouseout = function () {c.chart.rollOutMapObject(a)};
      e.onclick = function () {c.chart.clickMapObject(a)}
    }
  }
});