...
if (!empty($_POST['do'])) {
  switch ($_POST['do']) {
    ...
    case 'cpd_update' :
      ...
      $count_per_day->options['fieldlen'] = min([intval($_POST['cpd_fieldlen']), 500]);
    ...
    case 'cpd_collect' :
      ...
      $d = get_option('count_per_day_collected', []) + $d;
    ...
    case 'cpd_searchclean' :
      ...
      $searches = get_option('count_per_day_search', []);
...
// show options page
    ...
    <div id="cpdtoolccs" class="wrap">
      ...
      <h2><img src="<?php echo $count_per_day->img('cpd_logo.png') ?>" alt="Logo" class="cpd_logo"/> Count per Day
      </h2>

      <h2 class="nav-tab-wrapper">
        <a href="?page=count-per-day/counter-options.php&amp;tab=tools"
           class="nav-tab <?php echo $active_tab == 'tools' ? 'nav-tab-active' : ''; ?>"><span
            class="cpd_icon cpd_tools">&nbsp;</span> <?php _e('Tools') ?></a>
        <a href="?page=count-per-day/counter-options.php&amp;tab=options"
           class="nav-tab <?php echo $active_tab == 'options' ? 'nav-tab-active' : ''; ?>"><span
            class="cpd_icon cpd_settings">&nbsp;</span> <?php _e('Settings') ?></a>
      </h2>
      ...
      <div id="poststuff" class="cpd_settings">
                ...
                <?php if ($sum) { ?>
                  <p>
                    ...
                    <input type="submit" name="clean"
                           value="<?php printf(__('Delete these %s counts', 'cpd'), $sum) ?>" class="button"/>
                  </p>
                <?php } ?>
              </form>
            </div>
              ...
              <div class="inside">
                <form method="post" action="<?php echo $mysiteurl ?>">
                  ...
                  <p>
                    ...
                    <input type="submit" name="cpd_export" value="<?php _e('Export entries', 'cpd') ?>"
                           class="button"/>
                  </p>
                </form>
              </div>
              ...
              <div class="inside">
                <form method="post" action="<?php echo $mysiteurl ?>">
                  ...
                  <p>
                    ...
                    <input type="submit" name="backup" value="<?php _e('Backup the database', 'cpd') ?>"
                           class="button"/>
                  </p>
                </form>
                <?php
                if (is_writable(WP_CONTENT_DIR)) {
                  ...
                  <p>
                    <span class="cpd_green">+</span> <?php _e('add backup to current counter table', 'cpd') ?><br/>
                        <span
                          class="cpd_green">&uArr;</span> <?php _e('replace current counter table with with backup', 'cpd') ?>
                    <br/>
                ...
                <div class="inside">
                  <form method="post" action="<?php echo $mysiteurl ?>">
                    ...
                    <p>
                      ...
                      <input type="submit" name="clean" value="<?php _e('Clean the database', 'cpd') ?>"
                             class="button"/>
                    </p>
                  </form>
                  ...
                  <form method="post" action="<?php echo $mysiteurl ?>">
                    ...
                    <p>
                      ...
                      <input type="submit" name="clean" value="<?php _e('Delete search strings', 'cpd') ?>"
                             class="button"/>
                    </p>
                  </form>
                  ...
                  <form method="post" action="<?php echo $mysiteurl ?>">
                    <p style="border-top:1px #ddd solid; padding-top:10px">
                      <?php printf(__('Current size of your counter table %s is %s.', 'cpd'), '<code>' . $wpdb->cpd_counter . '</code>', $count_per_day->getTableSize($wpdb->cpd_counter)); ?>
                      <br/>
                    ...
                    <p>
                      ...
                      <input type="submit" name="clean" value="<?php _e('Delete clients and referers', 'cpd') ?>"
                             class="button"/>
                    </p>
                  </form>
                </div>
              ...
              <div class="inside">
                <form method="post" action="<?php echo $mysiteurl ?>">
                  ...
                  <p>
                    ...
                    <input type="submit" name="collect" value="<?php _e('Collect old data', 'cpd') ?>"
                           class="button"/>
                  </p>
                </form>
              </div>
          ...
          <div class="cpd_halfsize">
                ...
                <?php if ($cpd_geoip) {
                  ...
                  <form method="post" action="<?php echo $mysiteurl ?>">
                    <p>
                      ...
                      <input type="submit" name="updcon" value="<?php _e('Update old counter data', 'cpd') ?>"
                             class="button"/>
                    </p>
                  </form>
                <?php } ?>
                ...
                <?php if (class_exists('CpdGeoIp') && ini_get('allow_url_fopen') && function_exists('gzopen')) {
                  ...
                  <form method="post" action="<?php echo $mysiteurl ?>">
                    <p>
                      ...
                      <input type="submit" name="updcondb" value="<?php _e('Update GeoIP database', 'cpd') ?>"
                             class="button"/>
                    </p>
                  </form>
                <?php } ?>
                ...
                <?php if (!file_exists($cpd_geoip_dir . 'geoip.inc') || filesize($cpd_geoip_dir . 'geoip.inc') < 1000) {
                  ...
                  <form method="post" action="<?php echo $mysiteurl ?>">
                    <p>
                      ...
                      <input type="submit" name="loadgeoipaddon" value="<?php _e('Install GeoIP addon', 'cpd') ?>"
                             class="button"/>
                    </p>
                  </form>
                <?php } ?>
              ...
              <div class="inside">
                ...
                <form method="post" action="<?php echo $mysiteurl ?>">
                  <p>
                    ...
                    <input type="submit" name="activate" value="<?php _e('ReActivate the plugin', 'cpd') ?>"
                           class="button"/>
                  </p>
                </form>
              </div>
              ...
              <div class="inside">
                ...
                <form method="post" action="<?php echo $mysiteurl ?>">
                  <p>
                    ...
                    <input type="submit" name="clean" value="<?php _e('Reset the counter', 'cpd') ?>"
                           class="button cpd_red"/>
                  </p>
                </form>
              </div>
            </div>
            ...
            <form method="post" action="<?php echo $mysiteurl ?>">
              <div class="postbox">
                ...
                <div class="inside">
                  <p>
                    <?php _e('If "Count per Day" only disabled the tables in the database will be preserved.', 'cpd') ?>
                    <br/>
                  ...
                  <p>
                    ...
                    &nbsp;
                    <input type="submit" name="do" value="<?php _e('UNINSTALL Count per Day', 'cpd') ?>"
                           class="button cpd_red"
                           onclick="return confirm('<?php _e('You are sure to disable Count per Day and delete all data?', 'cpd') ?>')"/>
                  </p>
                </div>
              </div>
            </form>
        ...
        <form method="post" action="<?php echo $mysiteurl ?>">
          ...
          <fieldset>
            ...
            <table class="form-table">
              <tr>
                ...
                <td><input class="code" type="text" name="cpd_onlinetime" size="3"
                           value="<?php echo $o['onlinetime']; ?>"/> <?php _e('Seconds for online counter. Used for "Visitors online" on dashboard page.', 'cpd') ?>
                </td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Logged on Users', 'cpd') ?>:</th>
                <td>
                  <label for="cpd_user"><input type="checkbox" name="cpd_user"
                                               id="cpd_user" <?php if ($o['user'] == 1) echo 'checked="checked"'; ?> /> <?php _e('count too', 'cpd') ?>
                  </label>
                  - <?php _e('until User Level', 'cpd') ?>
                  <select name="cpd_user_level">
                    <option
                      value="10" <?php selected($o['user_level'], 10) ?>><?php echo translate_user_role('Administrator') ?>
                      (10)
                    </option>
                    <option
                      value="7" <?php selected($o['user_level'], 7) ?>><?php echo translate_user_role('Editor') ?> (7)
                    </option>
                    <option
                      value="2" <?php selected($o['user_level'], 2) ?>><?php echo translate_user_role('Author') ?> (2)
                    </option>
                    <option
                      value="1" <?php selected($o['user_level'], 1) ?>><?php echo translate_user_role('Contributor') ?>
                      (1)
                    </option>
                    <option
                      value="0" <?php selected($o['user_level'], 0) ?>><?php echo translate_user_role('Subscriber') ?>
                      (0)
                    </option>
                  </select>
                </td>
              ...
              <tr>
                ...
                <td><label for="cpd_autocount"><input type="checkbox" name="cpd_autocount"
                                                      id="cpd_autocount" <?php checked($o['autocount'], 1) ?> /> <?php _e('Counts automatically single-posts and pages, no changes on template needed.', 'cpd') ?>
                  </label></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <input class="code" type="text" name="cpd_exclude_countries" size="50"
                         value="<?php echo str_replace(',', ', ', $o['exclude_countries']); ?>"/><br/>
              ...
              <tr>
                ...
                <td><label for="cpd_anoip"><input type="checkbox" name="cpd_anoip"
                                                  id="cpd_anoip" <?php checked($o['anoip'], 1) ?> /> a.b.c.d &gt;
                    a.b.c.x</label></td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Cache', 'cpd') ?> (beta):</th>
                <td><label for="cpd_ajax"><input type="checkbox" name="cpd_ajax"
                                                 id="cpd_ajax" <?php checked($o['ajax'], 1) ?> /> <?php _e('I use a cache plugin. Count these visits with ajax.', 'cpd') ?>
                  </label></td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Clients and referrers', 'cpd') ?>:</th>
                <td>
                  <label for="cpd_referers"><input type="checkbox" name="cpd_referers"
                                                   id="cpd_referers" <?php checked($o['referers'], 1) ?> />
                    <?php _e('Save and show clients and referrers.<br />Needs a lot of space in the database but gives you more detailed informations of your visitors.', 'cpd') ?>
                    (1000000 <?php _e('Reads', 'cpd') ?> ~ 130 MB)</label><br/>
                  <label style="padding-top:10px" for="cpd_referers_cut"><input type="checkbox"
                                                                                name="cpd_referers_cut"
                                                                                id="cpd_referers_cut" <?php checked($o['referers_cut'], 1) ?> />
                  ...
                  <input class="code" style="margin-top:10px" type="text" name="cpd_fieldlen" size="3"
                         value="<?php echo $o['fieldlen'] ?>"/>
              ...
              <tr>
                ...
                <td>
                  <input class="code" type="text" name="cpd_posttypes" size="50"
                         value="<?php echo (isset($o['posttypes'])) ? str_replace(',', ', ', $o['posttypes']) : ''; ?>"/><br/>
          ...
          <fieldset>
            ...
            <table class="form-table">
              <tr>
                ...
                <td>
                  <?php $cus = (in_array($o['whocansee'], ['manage_options', 'edit_others_posts', 'publish_posts', 'edit_posts', 'read'])) ? 0 : 1 ?>
                  <select id="cpd_whocansee" name="cpd_whocansee" onchange="checkcustom()">
                    <option
                      value="manage_options" <?php selected($o['whocansee'], 'manage_options') ?>><?php echo translate_user_role('Administrator') ?> </option>
                    <option
                      value="edit_others_posts" <?php selected($o['whocansee'], 'edit_others_posts') ?>><?php echo translate_user_role('Editor') ?></option>
                    <option
                      value="publish_posts" <?php selected($o['whocansee'], 'publish_posts') ?>><?php echo translate_user_role('Author') ?></option>
                    <option
                      value="edit_posts" <?php selected($o['whocansee'], 'edit_posts') ?>><?php echo translate_user_role('Contributor') ?></option>
                    <option
                      value="read" <?php selected($o['whocansee'], 'read') ?>><?php echo translate_user_role('Subscriber') ?></option>
              ...
              <tr>
                ...
                <td><input class="code" type="text" name="cpd_dashboard_posts" size="3"
                           value="<?php echo $o['dashboard_posts']; ?>"/> <?php _e('How many posts do you want to see on dashboard page?', 'cpd') ?>
                </td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Latest Counts - Posts', 'cpd') ?>:</th>
                <td><input class="code" type="text" name="cpd_dashboard_last_posts" size="3"
                           value="<?php echo $o['dashboard_last_posts']; ?>"/> <?php _e('How many posts do you want to see on dashboard page?', 'cpd') ?>
                </td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Latest Counts - Days', 'cpd') ?>:</th>
                <td><input class="code" type="text" name="cpd_dashboard_last_days" size="3"
                           value="<?php echo $o['dashboard_last_days']; ?>"/> <?php _e('How many days do you want look back?', 'cpd') ?>
                </td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Chart - Days', 'cpd') ?>:</th>
                <td><input class="code" type="text" name="cpd_chart_days" size="3"
                           value="<?php echo $o['chart_days']; ?>"/> <?php _e('How many days do you want look back?', 'cpd') ?>
                </td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Chart - Height', 'cpd') ?>:</th>
                <td><input class="code" type="text" name="cpd_chart_height" size="3"
                           value="<?php echo $o['chart_height']; ?>"/> px
                  - <?php _e('Height of the biggest bar', 'cpd') ?></td>
              </tr>
              <?php if ($cpd_geoip) { ?>
                <tr>
                  <th scope="row" style="white-space:nowrap"><?php _e('Countries', 'cpd') ?>:</th>
                  <td><input class="code" type="text" name="cpd_countries" size="3"
                             value="<?php echo $o['countries']; ?>"/> <?php _e('How many countries do you want to see on dashboard page?', 'cpd') ?>
                  </td>
                </tr>
              <?php } ?>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Browsers', 'cpd') ?>:</th>
                <td><input class="code" type="text" name="cpd_clients" size="50"
                           value="<?php echo $o['clients']; ?>"/><br/><?php _e('Substring of the user agent, separated by comma', 'cpd') ?>
                </td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Search strings', 'cpd') ?>
                  /<?php _e('Referrers - Entries', 'cpd') ?>:
                </th>
                <td><input class="code" type="text" name="cpd_dashboard_referers" size="3"
                           value="<?php echo $o['dashboard_referers']; ?>"/> <?php _e('How many referrers do you want to see on dashboard page?', 'cpd') ?>
                </td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Search strings', 'cpd') ?>
                  /<?php _e('Referrers - Days', 'cpd') ?>:
                </th>
                <td><input class="code" type="text" name="cpd_referers_last_days" size="3"
                           value="<?php echo $o['referers_last_days']; ?>"/> <?php _e('How many days do you want look back?', 'cpd') ?>
                </td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Local URLs', 'cpd') ?>:</th>
                <td><label for="cpd_localref"><input type="checkbox" name="cpd_localref"
                                                     id="cpd_localref" <?php checked($o['localref'], 1) ?> />  <?php _e('Show local referrers too.', 'cpd') ?>
                    (<?php echo bloginfo('url') ?>/...)</label></td>
              </tr>
            </table>
          </fieldset>
          ...
          <?php // lists ?>
          <fieldset>
            <legend><span class="cpd_icon cpd_settings">&nbsp;</span> <?php _e('Posts') ?> / <?php _e('Pages') ?>
            </legend>
            <table class="form-table">
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Show in lists', 'cpd') ?>:</th>
                <td><label for="cpd_show_in_lists"><input type="checkbox" name="cpd_show_in_lists"
                                                          id="cpd_show_in_lists" <?php checked($o['show_in_lists'], 1) ?> /> <?php _e('Show "Reads per Post" in a new column in post management views.', 'cpd') ?>
                  </label></td>
              </tr>
            </table>
          </fieldset>
          ...
          <fieldset>
            ...
            <table class="form-table">
              ...
              <tr>
                ...
                <td><input class="code" type="text" name="cpd_startdate" size="10"
                           value="<?php echo $o['startdate']; ?>"/> <?php _e('Your old Counter starts at?', 'cpd') ?>
                  [yyyy-mm-dd]
                </td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Start count', 'cpd') ?>:</th>
                <td><input class="code" type="text" name="cpd_startcount" size="10"
                           value="<?php echo $o['startcount']; ?>"/> <?php _e('Add this value to "Total visitors".', 'cpd') ?>
                </td>
              </tr>
              <tr>
                <th scope="row" style="white-space:nowrap"><?php _e('Start count', 'cpd') ?>:</th>
                <td><input class="code" type="text" name="cpd_startreads" size="10"
                           value="<?php echo $o['startreads']; ?>"/> <?php _e('Add this value to "Total reads".', 'cpd') ?>
                </td>
              </tr>
            </table>
          </fieldset>
          ...
          <fieldset>
            ...
            <table class="form-table">
              <tr>
                ...
                <td><label for="cpd_no_front_css"><input type="checkbox" name="cpd_no_front_css"
                                                         id="cpd_no_front_css" <?php checked($o['no_front_css'], 1) ?> /> <?php _e('Do not load the stylesheet "counter.css" in frontend.', 'cpd') ?>
                  </label></td>
              </tr>
            </table>
          </fieldset>
          ...
          <fieldset>
            ...
            <table class="form-table">
              <tr>
                ...
                <td>
                  <input class="code" type="text" name="cpd_backup_part" size="10"
                         value="<?php echo $o['backup_part']; ?>"/>
          ...
          <?php // debug ?>
          <fieldset>
            <legend style="color:red"><span
                class="cpd_icon cpd_settings">&nbsp;</span> <?php _e('Debug mode', 'cpd') ?></legend>
            <p style="margin-top:15px;margin-left:10px">
              <label for="cpd_debug"><input type="checkbox" name="cpd_debug"
                                            id="cpd_debug" <?php checked($o['debug'], 1) ?> /> <?php _e('Show debug informations at the bottom of all pages.', 'cpd') ?>
              </label>
            </p>
          </fieldset>
